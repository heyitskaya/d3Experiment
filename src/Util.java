...
public class Util {
	...
	// just use EST rather than something fancier; TBD -- how might we configure
	// this for different users.
	...
	public static String encodeParametersInURL(Map<String, String> params, String url) {
		...
		try {
			...
			// This should never happen, because "UTF-8" is always installed in
			// Java.
